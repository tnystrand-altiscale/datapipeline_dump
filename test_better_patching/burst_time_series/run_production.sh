...
$SPARK_HOME/bin/spark-submit \
    ...
    --kafkaBrokers kafka-stag01.test.altiscale.com:9092 \
    --checkpointDirectory /user/$USER/spark_streaming_checkpoint/ApplicationSummarySlotHourStream_production \
    --enableCheckpointing \
    --checkpointInterval 60 \
    --processingInterval 60 \
    --nameTag stag-cluster
