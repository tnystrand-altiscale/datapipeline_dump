...
set hiveconf:target_table=thomas_tableau.select_minute_memory_data;
...
as with
    -- Make sure to only select minutes bigger than the actual partition date (avoid first half-day)
    crd_reduced
    as (
    select
        *
