...
set hiveconf:target_table=thomas_tableau.experimental_mem_time_series;
...
create table ${hiveconf:target_table}
    (
        ...
        job_id String,
        num_containers Int,
        num_waiting_containers Int,
        container_wait_time Double,
        container_wait_memory_v1 Double,
        container_wait_memory_v2 Double,
        container_wait_spacetime Double,
        memory Double,
        max_container_size Double,
        memory_noreserved Double,
        vcores Int,
        ...
        cluster_vcore_capacity Int,
        memory_capacity Double,
        memory_max_capacity Double,
        vcore_capacity Double,
        vcore_max_capacity Double
    )
stored as
    orc;
